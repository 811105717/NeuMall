...
public interface commodityCenterMapper {
   ...
   Boolean  addOrderDetail(@Param("orderDetailId")String orderDetailId,@Param("commodityId")String commodityId,@Param("commodityPrice")String commodityPrice,@Param("commodityNum")String commodityNum,@Param("commondityTotalPrice")String commondityTotalPrice);//提交订单
