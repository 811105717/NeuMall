...
public interface commodityCenterMapper {
   ...
   Boolean addShoppingCart(@Param("shopId") String shopId, @Param("commodityId") String commodityId, @Param("shopNumber")String shopNumber, @Param("customerId")String customerId, @Param("commodityNum")String commodityNum);//加入购物车
