...
public interface commodityCenterSerivice {
    ...
    AppResponse addShoppingCart(CommodityInfo commodityInfo, OrderDetail orderDetail, CustomerInfo customerInfo);//加入购物车
    ...
    AppResponse commodityCollection();//添加收藏/取消收藏
